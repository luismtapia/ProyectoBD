...
public class EmpleadosController implements Initializable{
    ...
    private void seleccionar(){
        List<Empleado> sval = lista.getSelectionModel().getSelectedItems();
            for(int i=0;i<sval.size();i++){
                Empleado empleadoSeleccionado = sval.get(i);
                try{
    ...
    private void crear(){
        try {
            ...
            Empleado nuevoEmpleado= new Empleado(0, nombre_empleado.getText(),  direccion_empleado.getText(), _Date_contratacion, nivel_);
